                                ...
                                {tags.slice(0, 10).map((tag, index) => (
                                    <button
                                        ...
                                        className={`px-2 py-1 rounded text-xs transition-colors ${
                                            filters.tag === tag
                                                ? 'bg-gray-700 text-white'
                                                : 'bg-dark-300 text-gray-500 hover:text-white'
                                        }`}
                                    >
                                        #{tag}
                                    </button>
                        ...
                        {pagination.totalPages > 1 && (
                            <div className="flex justify-center items-center gap-2 mt-8">
                                <button
                                    ...
                                    className="px-4 py-2 bg-dark-100 border border-gray-800 text-gray-400 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed hover:text-white hover:border-gray-700"
                                >
                                    Previous
                                </button>
